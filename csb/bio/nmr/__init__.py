...
class RandomCoil(object):
    """
    Controls the access to L{RandomCoil.RandomCoil}.
    """
    ...
    def get():
        """
        Get the L{RandomCoil.RandomCoil} instance (and create it, if this
        method is called for the first time).
        """
        if RandomCoil._instance is None:
            RandomCoil._instance = RandomCoil.RandomCoil()
    ...
    class RandomCoil(object):
        ...
        def _initialize(self):
            ...
            ref = os.path.join(RandomCoil.RandomCoil.RESOURCES, 'RandomCoil.Reference.tsv')            
            cor = os.path.join(RandomCoil.RandomCoil.RESOURCES, 'RandomCoil.Corrections.tsv')
